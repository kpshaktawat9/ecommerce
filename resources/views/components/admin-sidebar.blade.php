...
<div class="sidebar-wrapper" data-simplebar="true">
    <div class="sidebar-header">
        ...
        <div>
            <h4 class="logo-text">Kripa Mart</h4>
        </div>
    ...
    <ul class="metismenu" id="menu">
        ...
        <li>
            <a href="{{route('admin.attribute-value')}}">
                <div class="parent-icon"><i class='bx bx-cookie'></i>
                </div>
                <div class="menu-title">Attribute Values</div>
            </a>
        </li>
        <li>
        ...
        <li>
            <a href="{{route('admin.category-attribute')}}">
                <div class="parent-icon"><i class='bx bx-cookie'></i>
                </div>
                <div class="menu-title">Category Attributes</div>
            </a>
        </li>
        <li>
            <a href="javascript:;" class="has-arrow">
        ...
        <li>
            <a href="user-profile.html">
                ...
                <div class="menu-title"><a href="{{route('admin.profile')}}">User Profile</a></div>
            </a>
        </li>
        {{-- <li>
