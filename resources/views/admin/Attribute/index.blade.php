...
@section('content')
		...
		<div class="page-wrapper">
			<div class="page-content">
				...
				<button type="button" class="btn btn-primary" id="createAttributeBtn" data-bs-toggle="modal" data-bs-target="#AttributeModal">Add Attribute</button>
				...
				<div class="modal fade" id="AttributeModal" tabindex="-1" aria-labelledby="AttributeModalLabel" aria-hidden="true">
					<div class="modal-dialog">
						<div class="modal-content">
							<form id="AttributeForm" action="{{route('admin.attribute.store')}}" enctype="multipart/form-data">
								@csrf
								<div class="modal-header">
									<h5 class="modal-title" id="AttributeModalLabel">Add Attribute Attribute</h5>
								...
								<div class="modal-body">
									...
									<div class="mb-3">
										...
										<input type="text" class="form-control" id="attribute_slug" name="slug" required>
									</div>
								</div>

								<div class="modal-footer">
									<button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
									<button type="submit" class="btn btn-primary" id="saveAttributeBtn">Save</button>
								</div>
							</form>
						</div>
					</div>
							...
							<table id="AttributeTable" class="table table-striped table-bordered">
								...
								<tbody>
									...
									<tr>
										...
										<td>
											<button class="btn btn-sm btn-primary editAttributeBtn" 
													data-attribute='@json($attribute)'>
												Edit
											</button>
											<button class="btn btn-sm btn-danger deleteAttributeBtn" 
	...
	<script>
		...
		$(document).ready(function() {
			...
			$("#createAttributeBtn").on("click", function () {
				$("#AttributeModalLabel").text("Add Attribute Attribute");
				$("#saveAttributeBtn").text("Save");
			...
			$(document).on("click", ".editAttributeBtn", function () {
				...
				$("#AttributeModalLabel").text("Edit Attribute Attribute");
				$("#saveAttributeBtn").text("Update");
